...
export default function ContactMe() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Simuler l'envoi de l'email (ex: EmailJS, API Route...)
    ...
    return (
        <section className="bg-white pb-24 relative" id="contact">
        <div className="max-w-7xl mx-auto relative z-10 px-6">
            ...
            >
                ...
                <div className="pt-4 space-y-4">
                    ...
                    <div className="flex items-center space-x-3 text-sm text-slate-600 bg-slate-50 border border-slate-100 p-3 rounded-2xl w-fit shadow-sm">
                        ...
                        <button
                            ...
                            className="ml-2 p-1.5 rounded-xl text-slate-400 hover:text-blue-600 hover:bg-blue-50 transition-all cursor-pointer focus:outline-none"
                    ...
                    {/* Badges de Réseaux professionnels (Formatés comme le bouton du Hero) */}
                    <div className="flex items-center space-x-4 pt-2">
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className="flex items-center space-x-2 text-xs font-bold text-slate-600 hover:text-blue-600 transition-all duration-300 bg-slate-50 hover:bg-blue-50/50 px-4 py-3 rounded-xl border border-slate-200/60 shadow-sm"
                        >
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className="flex items-center space-x-2 text-xs font-bold text-slate-600 hover:text-slate-900 transition-all duration-300 bg-slate-50 hover:bg-slate-100 px-4 py-3 rounded-xl border border-slate-200/60 shadow-sm"
                        >
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-5 text-left">
                    ...
                    {/* Nom */}
                    <div>
                    <label htmlFor="name" className="block text-xs font-black text-slate-700 uppercase tracking-wider mb-2">
                        Nom Complet
                    </label>
                    <input
                        type="text"
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-800 focus:outline-none focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-50/50 transition-all"
                    ...
                    <select
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-800 focus:outline-none focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-50/50 transition-all cursor-pointer"
                    >
                    ...
                    {/* Message */}
                    <div>
                    <label htmlFor="message" className="block text-xs font-black text-slate-700 uppercase tracking-wider mb-2">
                        Message
                    </label>
                    <textarea
                        id="message"
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-800 focus:outline-none focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-50/50 transition-all resize-none"
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 rounded-xl text-md transition-all duration-300 shadow-xl shadow-blue-100 flex items-center justify-center space-x-2 disabled:opacity-50 active:scale-[0.98] cursor-pointer"
                    >
                    {isSubmitting ? (
