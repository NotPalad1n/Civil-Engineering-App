...
export const StripFootingIcon = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" className={className}>
    {/* Base de la semelle (Parties visibles uniquement) */}
    {/* Arêtes verticales et contours du bas */}
    <path d="M2 15V18L8 21L22 14V11" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M8 18V21" strokeLinecap="round" strokeLinejoin="round" />
    
    {/* Face supérieure de la semelle : Coupée au niveau du mur/fût */}
    {/* S'arrête aux intersections avec les arêtes verticales du mur à l'arrière */}
    <path d="M6 13L2 15L8 18L22 11L18 9" strokeLinecap="round" strokeLinejoin="round" />
    
    {/* Mur de la semelle filante (Fût allongé) */}
    {/* Face supérieure du mur */}
    <path d="M6 7L16 2L18 3L8 8Z" strokeLinecap="round" strokeLinejoin="round" />
    {/* Arêtes verticales extérieures et base du mur */}
    <path d="M6 7V15L8 16L18 11V3" strokeLinecap="round" strokeLinejoin="round" />
    {/* Arête centrale (frontale) du mur */}
    <path d="M8 8V16" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
